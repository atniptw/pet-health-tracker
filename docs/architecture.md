...
- **Account deletion:** Apple requires it in-app. Deleting an account removes pets where the user is the only member and just removes the user from shared pets.
